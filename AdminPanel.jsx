...
const getDefaultPackages = () => [
  ...
  { id: 'C3', name: '3. Coffee Break + 2 Bocados Simples (Mixto)', description: 'Infusiones, jugo y agua + 2 bocados simples (Dulces).', basePrice: 5400, attendeesBase: 1, bocadoSimpleCount: 2, hasNespressoOption: true },
  { id: 'C3N', name: '3. Coffee Break + 2 Bocados Simples (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados simples (Dulces).', basePrice: 6800, attendeesBase: 1, bocadoSimpleCount: 2, isNespresso: true },
