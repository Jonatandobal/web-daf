...
const getDefaultPackages = () => [
  { id: 'C1', name: '1. Coffee Break (Simple)', description: 'Infusiones, jugo y agua.', basePrice: 2860, attendeesBase: 1, hasNespressoOption: true },
  { id: 'C1N', name: '1. Coffee Break (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua.', basePrice: 4420, attendeesBase: 1, isNespresso: true },
  { id: 'C2', name: '2. Coffee Break + 2 Facturas', description: 'Infusiones, jugo y agua + 2 Facturas.', basePrice: 4940, attendeesBase: 1, bocadoFacturaCount: 2, hasNespressoOption: true },
  { id: 'C2N', name: '2. Coffee Break + 2 Facturas (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 Facturas.', basePrice: 7280, attendeesBase: 1, bocadoFacturaCount: 2, isNespresso: true },
  { id: 'C3', name: '3. Coffee Break + 2 Bocados Simples (Mixto)', description: 'Infusiones, jugo y agua + 2 bocados simples (Dulce y/o Salado).', basePrice: 6760, attendeesBase: 1, bocadoSimpleTotalCount: 2, hasNespressoOption: true },
  { id: 'C3N', name: '3. Coffee Break + 2 Bocados Simples (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados simples (Dulce y/o Salado).', basePrice: 8515, attendeesBase: 1, bocadoSimpleTotalCount: 2, isNespresso: true },
  { id: 'C4', name: '4. Coffee Break + 2 Bocados Especiales (Dulce y/o Salado)', description: 'Infusiones, jugo y agua + 2 bocados especiales (Dulce y/o Salado).', basePrice: 7540, attendeesBase: 1, bocadoEspecialTotalCount: 2, hasNespressoOption: true },
  { id: 'C4N', name: '4. Coffee Break + 2 Bocados Especiales (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados especiales (Dulce y/o Salado).', basePrice: 9815, attendeesBase: 1, bocadoEspecialTotalCount: 2, isNespresso: true },
  { id: 'C5', name: '5. Coffee Break + 2 Bocados Salados Especiales', description: 'Infusiones, jugo y agua + 2 bocados salados especiales.', basePrice: 8580, attendeesBase: 1, bocadoEspecialSaladoCount: 2, hasNespressoOption: true },
  { id: 'C5N', name: '5. Coffee Break + 2 Bocados Salados Especiales (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados salados especiales.', basePrice: 10920, attendeesBase: 1, bocadoEspecialSaladoCount: 2, isNespresso: true },
  { id: 'C6N', name: '6. Coffee Break (NESPRESSO) + 4 Bocados Especiales (Dulce y/o Salado)', description: 'Nespresso, infusiones, jugo y agua + 4 bocados especiales (Dulce y/o Salado).', basePrice: 10920, attendeesBase: 1, bocadoEspecialTotalCount: 4, isNespresso: true },
  { id: 'C7N', name: '7. Coffee Break (NESPRESSO) + 2 Empanadas + 2 Bocados', description: 'Nespresso, infusiones, jugo y agua + 2 empanadas + 2 bocados (dulces y/o salados simples).', basePrice: 12480, attendeesBase: 1, empanadaCount: 2, bocadoSimpleTotalCount: 2, isNespresso: true },
  { id: 'C8S', name: '8. BIENVENIDA SIMPLE', description: '1 bocado dulce simple + 3 bocados salados simples + 1 bebida (agua, gaseosa light o común).', basePrice: 11375, attendeesBase: 1, bocadoSimpleCount: 1, bocadoSaladoSimpleCount: 3, bebidaSimpleCount: 1 },
  { id: 'C9F', name: '9. BIENVENIDA FULL', description: 'Infusiones, jugo y agua + 2 bocados dulces esp. + 1 shot dulce + 5 bocados salados esp. + 1 bebida (agua, gaseosa light o común).', basePrice: 24051, attendeesBase: 1, bocadoEspecialDulceCount: 2, shotDulceCount: 1, bocadoEspecialSaladoCount: 5, bebidaSimpleCount: 1, hasNespressoOption: true },
  { id: 'C9FN', name: '9. BIENVENIDA FULL (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados dulces esp. + 1 shot dulce + 5 bocados salados esp. + 1 bebida (agua, gaseosa light o común).', basePrice: 26781, attendeesBase: 1, bocadoEspecialDulceCount: 2, shotDulceCount: 1, bocadoEspecialSaladoCount: 5, bebidaSimpleCount: 1, isNespresso: true },
];
