...
const getDefaultPackages = () => [
  ...
  { id: 'C4', name: '4. Coffee Break + 2 Bocados Especiales (Dulce y/o Salado)', description: 'Infusiones, jugo y agua + 2 bocados especiales (Dulce y/o Salado).', basePrice: 6000, attendeesBase: 1, bocadoEspecialTotalCount: 2, hasNespressoOption: true },
  ...
  { id: 'C6N', name: '6. Coffee Break (NESPRESSO) + 4 Bocados Especiales (Dulce y/o Salado)', description: 'Nespresso, infusiones, jugo y agua + 4 bocados especiales (Dulce y/o Salado).', basePrice: 8700, attendeesBase: 1, bocadoEspecialTotalCount: 4, isNespresso: true },
  { id: 'C7N', name: '7. Coffee Break (NESPRESSO) + 2 Empanadas + 2 Bocados', description: 'Nespresso, infusiones, jugo y agua + 2 empanadas + 2 bocados (dulces y/o salados simples).', basePrice: 10000, attendeesBase: 1, empanadaCount: 2, bocadoSimpleTotalCount: 2, isNespresso: true },
