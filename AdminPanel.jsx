...
const getDefaultPackages = () => [
  ...
  { id: 'C3', name: '3. Coffee Break + 2 Bocados Simples (Mixto)', description: 'Infusiones, jugo y agua + 2 bocados simples (Dulce y/o Salado).', basePrice: 5400, attendeesBase: 1, bocadoSimpleCount: 2, bocadoSaladoSimpleCount: 2, hasNespressoOption: true },
  { id: 'C3N', name: '3. Coffee Break + 2 Bocados Simples (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados simples (Dulce y/o Salado).', basePrice: 6800, attendeesBase: 1, bocadoSimpleCount: 2, bocadoSaladoSimpleCount: 2, isNespresso: true },
  { id: 'C4', name: '4. Coffee Break + 2 Bocados Especiales (Mixto)', description: 'Infusiones, jugo y agua + 2 bocados especiales (Dulce y/o Salado).', basePrice: 6000, attendeesBase: 1, bocadoEspecialDulceCount: 2, bocadoEspecialSaladoCount: 2, hasNespressoOption: true },
  { id: 'C4N', name: '4. Coffee Break + 2 Bocados Especiales (con NESPRESSO)', description: 'Nespresso, infusiones, jugo y agua + 2 bocados especiales (Dulce y/o Salado).', basePrice: 7900, attendeesBase: 1, bocadoEspecialDulceCount: 2, bocadoEspecialSaladoCount: 2, isNespresso: true },
