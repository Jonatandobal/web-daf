...
// --- CONFIGURACIÓN DEMO (Sin Firebase) ---
// Para la vista previa sin conexión a Firebase
...
const addons = [
  { name: 'Agua mineral 1.5lts', price: 2512 },
  { name: 'Gaseosa grande 2.25lts', price: 5382 },
  { name: 'Jugo Cepita x litro', price: 2990 },
  { name: 'Bocaditos salados (bandeja)', price: 2631 },
  { name: 'Frutas frescas (bandeja)', price: 1555 },
  { name: 'Yogurt bebible frutilla/vainilla x litro', price: 6578 },
    ...
    <div className="space-y-4">
      ...
      {orders.map((order) => (
        <div key={order.id} className="bg-white p-4 rounded-xl shadow-md border border-gray-100">
          ...
          <p className="mt-2 text-xs text-right text-gray-400">Creado: {order.createdAt}</p>
        </div>
      ))}
    </div>
  );
    ...
    return (
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-inner">
            ...
            <p className="text-xs text-gray-500 mb-3">
                Máximo de unidades <strong>TOTALES</strong> a elegir: <strong>{totalMax}</strong> (Base por asistente: {maxTotalPerAttendee} unidad/es)
            </p>
    ...
    <div className="min-h-screen bg-gray-100 p-4 sm:p-10 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <header className="text-center mb-8 p-6 bg-white rounded-xl shadow-lg border-b-4 border-indigo-400">
          ...
          <p className="text-xs text-gray-400 mt-2">Vista Demo - Sin conexión a base de datos</p>
        </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {needsBocadoSelection && (
                <div className="space-y-4 pt-4 border-t p-6 bg-blue-50 rounded-xl border border-blue-200">
                    ...
                    <p className="text-sm text-blue-700 italic">Elige la variedad de bocados <strong>totales</strong> que incluye tu paquete.</p>
                    ...
                    <div className="space-y-4">
                        ...
                        <BocadoSelector
                            title="Bocados Salados Simples (Medialuna J/Q, Petit Pain)"
                         ...
                         {isMixtoEspecial && (
                            <div className='bg-yellow-50 p-3 rounded-xl border border-yellow-300'>
                                ...
                                <p className='text-xs text-yellow-700 mb-3'>
                                    Tienes un total de <strong>{selectedPackage.bocadoEspecialTotalCount}</strong> unidades por asistente para dividir libremente.
                                </p>
                                <BocadoSelector
